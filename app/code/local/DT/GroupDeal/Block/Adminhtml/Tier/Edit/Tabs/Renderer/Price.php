 ...
 *
 */
class DT_GroupDeal_Block_Adminhtml_Tier_Edit_Tabs_Renderer_Price
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Price_Group_Abstract
{
    ...
    {
        $this->setTemplate('dt/groupdeal/edit/renderer/price.phtml');
    }
    ...
    public function getTier() {
        return Mage::registry('current_tier');
    }
}
